# Oriole 1894: source and method

The 40-point Ryan letters anchor the face, with the ATF GYMNASTICS showing and Ryan smaller sizes supplying missing capitals. The ATF 20-point line supplies all ten figures. Threshold 185 and light blur retain fine joining hairlines; component filtering removes isolated scan dust while retaining decorative islands. J, Q, X and Z are inferred. This remains a display face; the finest detail is best seen at larger sizes.
...
```sh
python scripts/trace_specimen.py oriole-1894 --output workspace/Oriole1894-Regular.otf
python scripts/fontrevival.py import oriole-1894 workspace/Oriole1894-Regular.otf
