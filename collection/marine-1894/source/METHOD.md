# Marine 1894: source and method

The larger ATF and Ryan mixed-case impressions anchor the face. Retain the isolated squares, diamond dots and crossed bowls. Smaller samples supply missing letters; size variants differ in weight. V, Y, X, Z, j, k, q, x, 0, 8 and 9 are inferred as listed in font.json. V follows the observed lowercase v; the descending Y follows y.
...
```sh
python scripts/trace_specimen.py marine-1894 --output workspace/Marine1894-Regular.otf
python scripts/fontrevival.py import marine-1894 workspace/Marine1894-Regular.otf
