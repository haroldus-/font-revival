# Erebus 1894: source and method

The solid, backslanted silhouette follows the larger ATF impressions, supplemented by Ryan for X. Preserve the extended A, H, N, V, W and Y strokes rather than forcing every outline into a flat cap rectangle. Hades shares these advances and kerning. The new J, Z, 0 and 4 follow the observed strokes.
...
```sh
python scripts/trace_specimen.py erebus-1894 --output workspace/Erebus1894-Regular.otf
python scripts/fontrevival.py import erebus-1894 workspace/Erebus1894-Regular.otf
