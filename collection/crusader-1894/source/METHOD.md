# Crusader 1894: source and method

The larger uncial E, crossed O/G/U, curled C/P and sloping A anchor the design. Ordinary N and M are retained from the 48-point showing. Optical sizes and alternates are not represented as separate styles. The four playing-card ornaments retain their printed orientation.
...
```sh
python scripts/trace_specimen.py crusader-1894 --output workspace/Crusader1894-Regular.otf
python scripts/fontrevival.py import crusader-1894 workspace/Crusader1894-Regular.otf
